function jogar(){
    ...
    if((document.getElementById("pedra").checked == true && sorteio == 0)
        ...
        ||(document.getElementById("tesoura").checkde == true && sorteio == 2))
        {
        ...
        {
                document.getElementById("placar").innerHTML = "EU PERDI!";
    }
    else{
        document.getElementById("placar").innerHTML = "EU GANHEI HAHAHAHA";
    }
    }
}
function resetar(){
